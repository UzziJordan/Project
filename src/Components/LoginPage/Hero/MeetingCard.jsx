 ...
 <div className="w-80 md:w-100 rounded-4xl border-[#FFFFFF]/10 border-2 mt-5 p-6 bg-[#FFFFFF]/6  text-geist">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <p className="text-[13px] font-semibold text-[#FFFFFF]/90">
            Q4 Strategy Meeting
          </p>
        </div>
      ...
      <div className="flex gap-3 mt-4">
        ...
        <div className="px-2 py-1 rounded-full bg-[#3B82F6]/25 border border-[#3B82F6]/40 text-[#93C5FD] text-[10px] font-semibold">
          ✦ Summary ready
        </div>
        ...
        <div className="px-2 py-1 rounded-full bg-[#FFFFFF]/5 border border-[#FFFFFF]/10 text-[#FFFFFF]/50 text-[10px] font-semibold">
          47 min
        </div>
