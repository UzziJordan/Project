...
<div className="bg-[#FFFFFF] mt-15 pl-10 md:pl-0 py-10 w-105 text-geist">
      ...
      <div className="flex bg-[#F3F4F6] rounded-lg p-1 h-10 text-[10px] md:text-[14px] font-semibold">
        <button className=" bg-[#FFFFFF] rounded-md px-15 md:px-18 py-1">
          Sign In
        </button>
      ...
      <h2 className="text-[20px] text-instrument-serif mt-15 mb-1 ">
        Welcome <br /> <span className="text-[#2828FA] italic">back.</span>
      </h2>
      ...
      {/* SIGN IN BUTTON */}
      <button className="w-full mt-6 py-3 rounded-xl text-white font-semibold 
