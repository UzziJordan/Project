            ...
            <div className="flex flex-col gap-5 md:flex md:flex-col md:gap-10 lg:flex-row lg:gap-40 mt-20">
                <div className="flex flex-col gap-5 md:flex md:flex-row md:gap-40 lg:flex-row items-start justify-center lg:gap-40">
                    ...
                    <div className="flex flex-col items-center text-center w-60">
                        ...
                        <div className="pt-4 mb-0">
                            ...
                            <p className="text-[#6B7280] text-[16px]"> Tap record during meetings, lectures, or interviews. </p>
                        </div>
                        <div>
                    ...
                    <div className="flex flex-col items-center text-center w-60">
                        ...
                        <div className="h-8 w-24 bg-[#2828FA]/10 rounded-2xl text-[#2828FA] font-semibold flex items-center justify-center mt-5"> STEP - 02 </div>
                        <div className="pt-4">
                            <p className="text-[#1F2937] text-[25px] font-bold">Transcribe</p>
                            <p className="text-[#6B7280] text-[16px]"> Memo AI converts speech into accurate searchable text. </p>
                        </div>
                ...
                <div className="flex flex-col items-center text-center w-60 md:mx-auto">
                    ...
                    <div className="pt-4">
                        ...
                        <p className="text-[#6B7280] text-[16px]"> Get smart summaries, key points and action items in seconds. </p>
                    </div>
                    <div>
                        <img src={line1} alt="line" />
                    </div>
