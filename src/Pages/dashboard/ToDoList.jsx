...
const ToDoList = () => {
    ...
    const weeklyGoal = 8; // Example goal
    ...
    return (
        <div className='text-geist pt-20'>
            ...
            <div className="pt-7 px-18">
                ...
                {/* PENDING */}
                <div className='mt-8'>
                    <p className="text-gray-400 text-sm font-semibold mb-3 uppercase tracking-widest">PENDING</p>
                    ...
                    <div className="space-y-3">
                        ...
                        {pendingTasks.map(task => (
                            <div key={task.id} className="bg-white border border-[#EBEBEB] rounded-xl p-6 flex justify-between items-center shadow-sm">
                ...
                <div className='mt-8 pb-10'>
                    <p className="text-gray-400 text-sm font-semibold mb-3 uppercase tracking-widest">COMPLETED</p>
